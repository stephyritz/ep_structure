/*EP*/
/* Création de vues matérialisées sur les données éclairage public*/
/* Objectif : Offrir la possibilité de visualiser les données globales via des jointures entre tables relationnelles pour répondre aux enjeux de gestion par la Communauté de Commune Thann-Cernay (CCTC)*/
...
/*    VUE ARMOIRES    */
/******************************************/
CREATE MATERIALIZED VIEW ep_apps.armoires AS
	SELECT
	o.id_objet,
    o.idsimpl_objet,
    o.datemaj_objet,
...
COMMENT ON MATERIALIZED VIEW ep_apps.armoires
  IS 'Vue matérialisée permettant l''affichage des informations liées aux armoire du réseau d''éclairage public';

GRANT ALL ON TABLE ep_apps.armoires TO "SIG";

/******************************************/
/*    VUE MOBILIER   */
/******************************************/
CREATE MATERIALIZED VIEW ep_apps.mobiliers AS
	SELECT
	o.id_objet,
    o.idsimpl_objet,
    o.datemaj_objet,
...
COMMENT ON MATERIALIZED VIEW ep_apps.mobiliers
  IS 'Vue matérialisée permettant l''affichage des informations liées aux mobiliers du réseau d''éclairage public';

GRANT ALL ON TABLE ep_apps.mobiliers TO "SIG";

/******************************************/
/*    VUE CHAMBRES    */
/******************************************/
CREATE MATERIALIZED VIEW ep_apps.chambres AS
	SELECT
	o.id_objet,
    o.idsimpl_objet,
    o.datemaj_objet,
...
COMMENT ON MATERIALIZED VIEW ep_apps.chambres
  IS 'Vue matérialisée permettant l''affichage des informations liées aux chambres du réseau d''éclairage public';

GRANT ALL ON TABLE ep_apps.chambres TO "SIG";

/******************************************/
/*    VUE SUPPORTS    */
/******************************************/
CREATE MATERIALIZED VIEW ep_apps.supports AS
	SELECT
	o.id_objet,
    o.idsimpl_objet,
    o.datemaj_objet,
...
COMMENT ON MATERIALIZED VIEW ep_apps.supports
  IS 'Vue matérialisée permettant l''affichage des informations liées aux supports du réseau d''éclairage public';

GRANT ALL ON TABLE ep_apps.supports TO "SIG";

/******************************************/
/*    VUE TRONCONS   */
/******************************************/

CREATE MATERIALIZED VIEW ep_apps.troncons AS
	SELECT
	o.id_objet,
    o.idsimpl_objet,
    o.datemaj_objet,
...
COMMENT ON MATERIALIZED VIEW ep_apps.troncons
  IS 'Vue matérialisée permettant l''affichage des informations liées aux tronçons du réseau d''éclairage public';

GRANT ALL ON TABLE ep_apps.troncons TO "SIG";

/******************************************/
/*    VUE POINTS LUMINEUX   */
/******************************************/

CREATE MATERIALIZED VIEW ep_apps.pointslumineux AS
	SELECT
	p.id_pl,
    p.marque_pl,
...
COMMENT ON MATERIALIZED VIEW ep_apps.pointslumineux
  IS 'Vue matérialisée permettant l''affichage des informations liées aux points lumineux du réseau d''éclairage public';

GRANT ALL ON TABLE ep_apps.pointslumineux TO "SIG";

/******************************************/
/*    VUE ACCESSOIRES   */
/******************************************/

CREATE MATERIALIZED VIEW ep_apps.accessoires AS
	SELECT
	a.id_accessoire,
	a.type_accessoire,
...
COMMENT ON MATERIALIZED VIEW ep_apps.accessoires
  IS 'Vue matérialisée permettant l''affichage des informations liées aux accessoires du réseau d''éclairage public';

GRANT ALL ON TABLE ep_apps.accessoires TO "SIG";
